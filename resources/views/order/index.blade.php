            ...
            <div class="d-grid gap-4">
                <div class="hstack gap-2">
                    ...
                    <div class="input-group">
                        <input type="text" placeholder="Cari product" class="form-control" name="search" autofocus>
                    </div>
                ...
                <div class="row g-4">
                    <div class="col-3">
                        <div class="card product-card">
                            <img src="https://www.themealdb.com/images/media/meals/qtuwxu1468233098.jpg" alt="Product 1"
                ...
                <div class="card-body border-bottom d-grid gap-2">
                    ...
                    <div>
                        ...
                        <div class="input-group">
                            ...
                            <x-text-input name="customer" label="Customer"></x-text-input>
                        </div>
                    </div>
                </div>
